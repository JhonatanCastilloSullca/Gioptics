...
<body>
    ...
    <div style="padding-left: 10px;">
        <div class="header-details">
            ...
            <p class="header-details-text text-left">MOTIVO: 
                @switch($venta->cod_note)
                    @case('01')
            ...
            <p class="header-details-text text-left">OBSERVACIÓN: {{$venta->descripcion}}</p>
            <table>
                <thead>
                    <tr>
                        <th>TIPO DOC.</th>
                ...
                <tbody>
                    <tr class="tr-odd">
                        <td>{{$venta->venta?->documento?->nombre }}</td>
                        <td>{{date("Y-m-d",strtotime($venta->venta?->fecha)) }}</td>
                        <td>{{$venta->venta?->documento?->serie}}</td>
                        <td>{{$venta->venta?->nume_doc}} </td>
                    </tr>
                </tbody>
            </table>
