...
@foreach($compra as $compra)
    ...
    {{csrf_field()}}
            ...
            <h4>Detalle de Pago</h4>
                ...
                <div class="form-group row">
                    <div class="col-md-2">
                        <input checked class="coupon_question" type="checkbox" name="coupon_question" value="1" onchange="valueChanged()"/>
                        <label style="padding-top: 20px;">&nbsp;&nbsp;&nbsp;Cuotas</label>
                    </div>
                    <div class="col-md-1">
                    </div>
                    <div class="col-md-3">  
                ...
                <div class="form-group row" >                    
                    ...
                    <div class="col-md-3" id="acuenta2">
                        ...
                        <input type="number" id="acuenta" max="{{$totalpedido}}" name="acuenta" class="form-control" placeholder="Ingrese cantidad" >
                        @error('acuenta')
                            <span class="error-message" style="color:red">*</span>
                        @enderror
                    </div>
